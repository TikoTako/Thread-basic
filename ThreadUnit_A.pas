...
constructor TTestThread_A.Create(PositionInArray, FakeWorkTime: integer);
begin
...
destructor TTestThread_A.Destroy;
begin
...
procedure TTestThread_A.Execute();
var
  i: integer;
  vTrouble: double;
